...
var ErrCreateBomItem = errors.New("there was an error while trying to register the good.")
var ErrCreateBomItemNotFound = errors.New("Unable to complete the order. Please check if you are sending the correct data using the correct method and URL.")
